...
\subsubsection{Aufsätze in Sammelpublikationen}\label{aufsaetze_in_sammelpublikationen}
Nutzen Sie \textit{Buchteil} als Eintragsart. 
\subsubsection{Aufsätze in Kongressberichten}
...
\subsubsection{Aufsätze in Festschriften}
Nutzen Sie die normale Form (siehe \nameref{aufsaetze_in_sammelpublikationen}). % label and Link the alternative
\subsubsection{Aufsätze in wissenschaftlichen Zeitschriften oder Jahrbüchern}
...
Eintragsart: \textit{Zeitungsartikel} (Achtung, \textbf{nicht} \textit{Zeitschriftenartikel}).
\pubtable{
